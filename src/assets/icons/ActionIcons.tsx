...
export const ClickIcon = () => (
    <svg className="w-8 h-8 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 15l-2 5L2 9l9 9z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 6l6 6" />
    </svg>
);
